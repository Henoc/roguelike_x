namespace model{
  ...
  tiles["treasure_box"] = new Tile("\u5B9D\u7BB1","","treasure_box",true,false,utils.some(new battle.Status(10,10,0,4)),4,[{name:"knife",per:0.7}, {name:"copper_armor", per:0.7}, {name:"silver_knife",per:0.3}, {name:"iron_armor",per:0.3}, {name:"gold_knife",per:0.1}, {name:"gold_armor", per:0.1}],{no_attack:true})
