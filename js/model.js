...
(function (model) {
    ...
    model.tiles["violent_ghost"] = new Tile("\u66B4\u308C\u30B4\u30FC\u30B9\u30C8", "", "violent_ghost", true, true, utils.some(new battle.Status(4, 4, 3, 0)), 4, [], { hide: true });
    // 実際の配置物
    var Entity = (function () {
    ...
    function monsters_action() {
        ...
        for (var _i = 0, entities_1 = model.entities; _i < entities_1.length; _i++) {
            ...
            // property: hide
            if ("hide" in ent.more_props)
                ent.more_props["hide"] = true;
