...
(function (items) {
    ...
    items.type = {
        ...
        mame_mouse_ibukuro: new Item("\u8C46\u306D\u305A\u307F\u306E\u80C3\u888B", ["use", "put"], new battle.Status(0, 0, 0, 0), "none", "\u98DF\u3079\u308B\u3068\u6D88\u5316\u3092\u7269\u7406\u7684\u306B\u52A9\u3051\u3066\u304F\u308C\u308B\u3068\u3044\u3046", { effi: 1 }),
        //dead_lang_dog: new Item("\u4EBA\u8A9E\u3092\u89E3\u3059\u72AC\u306E\u8089",["use","put"],battle.Status.of_food(1),"none",`\u72AC\u3068\u4EBA\u3068\u306E\u30AD\u30E1\u30E9\u3060\u3068\u3044\u3046\u8AAC\u304C\u3042\u308B`),
        lang_dog_shoes: new Item("\u72AC\u306E\u9774", ["equip", "put"], new battle.Status(0, 0, 0, 0), "foot", "\u77E5\u6027\u3092\u611F\u3058\u3055\u305B\u308B\u5E03\u88FD\u306E\u9774", { effi: 2 }),
        ...
        ghost_camouflage: new Item("\u5E7D\u4F53\u8FF7\u5F69", ["equip", "put"], new battle.Status(0, 0, 0, 1), "head", "\u88AB\u308B\u3068\u6575\u306B\u6C17\u3065\u304B\u308C\u306B\u304F\u304F\u306A\u308B", { camouflage: 0.5 })
    };
    /**
    ...
    function equips_more_props_sum() {
        var ret = {};
        for (var _i = 0, _a = ["head", "body", "hand", "foot"]; _i < _a.length; _i++) {
            var region = _a[_i];
            if (items.equips[region].exist()) {
